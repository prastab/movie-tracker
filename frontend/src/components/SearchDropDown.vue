...
// Expose showDropdown to parent component
...
<template>
    <div
        v-if="showDropdown"
        class="absolute w-full mt-2 bg-gray-900 rounded-md shadow-lg z-50"
    >
        <div v-if="isLoading" class="p-4 text-gray-400">Loading...</div>
        <div
        ...
        <ul v-else class="max-h-96 overflow-y-auto">
            <li
                ...
                :key="result.id"
                class="px-4 py-2 hover:bg-gray-800 cursor-pointer flex items-center gap-3"
            ...
            >
                ...
                <div class="flex-shrink-0 w-12 h-18">
                    ...
                    <div
                        v-else
                        class="w-full h-full bg-gray-700 rounded flex items-center justify-center text-gray-400"
                    >
                        No Image
                    </div>
                </div>
